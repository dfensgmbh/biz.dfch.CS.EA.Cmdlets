...
{
    [TestClass]
    public class SetTaggedValueTest
    {
        [TestMethod]
        ...
        {
            var parameters = @";";
            var results = new PsCmdletAssert2().Invoke(typeof(SetTaggedValue), parameters);
        }

        [TestMethod]
        public void SettingNewTaggedValueReturnsTrue()
        {
            ...
            {
                {nameof(SetTaggedValue.Repository), repository},
                {nameof(SetTaggedValue.ElementGuid), elementGuid},
                {nameof(SetTaggedValue.Name), name},
                {nameof(SetTaggedValue.Value), value},
                {nameof(SetTaggedValue.Force), false},
            };
        ...
        [TestMethod]
        public void SettingExistingTaggedValueWithoutForceReturnsVoid()
        {
            var elementGuid = new Guid("deaddead-dead-dead-dead-deaddeaddead");
            var name = "new-tagged-value-name";
            var value = "42";
        ...
        [TestMethod]
        public void SettingExistingTaggedValueWithForceReturnsFalse()
        {
            var elementGuid = new Guid("deaddead-dead-dead-dead-deaddeaddead");
            var name = "new-tagged-value-name";
            var value = "42";
            ...
            var parameters = new Dictionary<string, object>
            {
                ...
                {nameof(SetTaggedValue.Name), name},
                {nameof(SetTaggedValue.Value), value},
                {nameof(SetTaggedValue.Force), true},
            };
